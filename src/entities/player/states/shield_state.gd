extends PlayerState
## BARRIER style (both Chris and Flam): hold ability to block hits — melee,
## contact, or projectile — arriving from the ±60° frontal arc the shield
## faces; unlimited (no meter, no cooldown, hold as long as you want) at 30%
## walk speed. Blocking logic lives in Player._shield_blocks — this state
## only manages movement, the visible shield sprite, and exit. PARRY is a
## separate style/state (tap vs hold) that no shipped character currently
## uses.
